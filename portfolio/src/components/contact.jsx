  ...
  return (
    ...
    >
      ...
      className="w-5/12 h-full 2xl:h-4/6 ml-4 2xl:ml-6   relative    cus-form ">
        ...
        {isSubmit ? (
        <div className="w-full h-full relative  pb-16  pt-20 2xl:pb-20">
        <div className="w-11/12 ml-3 2xl:ml-5  h-1/2 justify cus-thankyou 2xl:pb-4  pb-4  rounded-lg ">
          ...
          <p className="text-md 2xl:text-lg pb-2 text-gray-500 mb-2 pr-2  2xl:pl-7 ">
        ...
        <p className="text-gray-700 ml-6 pt-3 2xl:text-2xl 2xl:ml-12 2xl:pt-10  text-xl  font-semibold">To Connect with Me! <br /> 
        <span className="text-sm 2xl:text-lg  text-gray-500 font-medium   mt-2  ">Fill this Form</span> 
          ...
          <input
              ...
              <p className="text-sm text-gray-500 pb-3  2xl:text-lg 2xl:ml-28 2xl:pb-3 font-medium ml-16">email me at <span className="text-gray-800 text-md"> sabnischinmay31@gmail.com </span></p>
            </div> 
      )}
