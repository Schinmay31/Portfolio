        ...
        >
          {isSubmit ? (
              ...
              <div className="w-11/12 ml-3 2xl:ml-5  h-1/2 justify cus-thankyou 2xl:pb-4   rounded-lg ">
                ...
                <div className="w-11/12 ml-3 h-full  mt-3 2xl:mt-5 ">
                  <p className="text-md 2xl:text-lg text-gray-500 mb-2 pr-2  2xl:pl-7 ">
                    I appreciate you taking the time to reach out to me. I'll
            ...
            <div className="w-full h-3/4  relative  justify-center ">
              <p className="text-gray-700 ml-6 pt-3 2xl:text-2xl 2xl:ml-12 2xl:pt-10  text-xl  font-semibold">
                To Connect with Me! <br />
                <span className="text-sm 2xl:text-lg  text-gray-500 font-medium   mt-2  ">
                  Fill this Form
                </span>
              </p>
              ...
              <p className="text-sm text-gray-500   2xl:text-lg 2xl:ml-28 2xl:pb-3 font-medium ml-16">
                email me at{" "}
